...
**Hasil:**
- Input: `Yona anak lucu dan menggemaskan`
- Output dari server: `YONA ANAK LUCU DAN MENGGEMASKAN`
...
**Hasil:**
- Input: `Yona anak baik rendah hati`
- Output dari server: `YONA ANAK BAIK RENDAH HATI`
